if((image_index == DMGFrame || image_index == DMGFrame+3 || image_index == DMGFrame+6) && abs(depth - other.depth) <= LayerSize && abs(y - other.GroundY) <= LayerSize && Owner == "Enemy"){
...
//(image_index == DMGFrame || image_index == DMGFrame+3 || image_index == DMGFrame+6)