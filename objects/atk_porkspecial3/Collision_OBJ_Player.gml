if((sprite_is_on_frame(DMGFrame) || sprite_is_on_frame(DMGFrame+1)) && abs(depth - other.depth) <= LayerSize && abs(y - other.GroundY) <= LayerSize && Owner == "Enemy" && other.IsDodging == false && hit != 1){
