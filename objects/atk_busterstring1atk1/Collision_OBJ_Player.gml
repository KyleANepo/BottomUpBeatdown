if((sprite_is_on_frame(DMGFrame) || sprite_is_on_frame(DMGFrame+5) || sprite_is_on_frame(DMGFrame+10)) && abs(depth - other.depth) <= LayerSize && abs(y - other.GroundY) <= LayerSize && Owner == "Enemy" && other.IsDodging == false){
